...
public class TC1_Calculator {
    ...
    @Test
    public void t1_calculator_accessingApp() throws MalformedURLException {
        ...
        //app info
        //cmd den önce  'adb shell' sonra 'dumpsys window | grep -E mCurrentFocus' yaparak ulaşıyoruz
